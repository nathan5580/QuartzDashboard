...
internal static class TriggerHandlers
{
    ...
    internal static void ApplyMisfireInstruction(CronScheduleBuilder builder, string? instruction)
    {
        switch (instruction)
        {
            case "fireOnceNow": builder.WithMisfireHandlingInstructionFireAndProceed(); break;
            case "doNothing": builder.WithMisfireHandlingInstructionDoNothing(); break;
            case "ignoreMisfirePolicy": builder.WithMisfireHandlingInstructionIgnoreMisfires(); break;
        }
    }
    ...
    internal static void ApplySimpleMisfireInstruction(SimpleScheduleBuilder builder, string? instruction)
    {
        switch (instruction)
        {
            case "fireOnceNow": builder.WithMisfireHandlingInstructionFireNow(); break;
            case "doNothing": builder.WithMisfireHandlingInstructionNextWithExistingCount(); break;
            case "ignoreMisfirePolicy": builder.WithMisfireHandlingInstructionIgnoreMisfires(); break;
        }
    }
}
